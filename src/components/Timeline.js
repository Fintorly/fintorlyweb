              ...
              <div className="t_item">
                ...
                <div className="t_item_info">
                  ...
                  <h3 className="fn_title">
                    <Link href="/roadmap-single">Projemizin İlk Aşaması</Link>
                  </h3>
                  <p className="fn_desc">
                    Projemizin ilk aşamasında, projemizin ilk aşamasında,
                    projemizin ilk aşamasında, projemizin ilk aşamasında,
                    projemizin ilk aşamasında, projemizin ilk aşamasında,
                  </p>
                  <p className="fn_read">
                    <Link href="/roadmap-single">
                      <a className="neoh_fn_button only_text">
                        <span className="text">Daha Fazla</span>
                      </a>
                    </Link>
                  </p>
                </div>
            ...
            >
              <ul>
                <li className={activeClass(1)}>
                  <a onClick={() => onClick(1)}>
                    <span className="text">Nisan 15, 2022</span>
                    <span
                      className="circle"
